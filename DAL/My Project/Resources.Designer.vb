...
Namespace My.Resources
    ...
    Friend Module Resources
        ...
        '''<summary>
        '''  Busca una cadena traducida similar a Data Source=LAMPA\SQLEXPRESS;Initial Catalog=Campo;Integrated Security=True.
        '''</summary>
        Friend ReadOnly Property con() As String
            Get
